...
export const fr: Record<TranslationKeys, string | undefined> = {
  ...
  "schedule.saturdayBreakfast": "Déjeuner — brunch style buffet",
  "schedule.saturdayLunch": "Dîner — buffet sandwich et autres",
  "schedule.saturdayCeremony": "Cérémonie à 16h30",
  ...
  "rsvp.nightsStaying": "Quelles nuits séjournerez-vous? (Choisissez toutes les options applicables)",
  "rsvp.nightFriday": "Vendredi soir",
  "rsvp.nightSaturday": "Samedi soir",
  ...
  "rsvp.declineTitle": "Nous sommes désolés que vous ne puissiez pas être des nôtres!",
  "rsvp.declineParagraph": "Vous allez nous manquer!",
  "rsvp.declineNote": "Laissez nous un message",
  ...
  "rsvp.validation.requireAccommodations": "Veuillez indiquer si vous avez besoin d'hébergement",
