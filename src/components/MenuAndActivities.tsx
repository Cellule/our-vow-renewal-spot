...
import { UtensilsCrossed, Gamepad2, Mic, Sparkles, Waves } from "lucide-react";
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-elegant rounded-2xl p-8 shadow-elegant">
              <h3 className="font-script text-2xl text-gold mb-6 text-center">
                {t("menu.mainCourse")}
              </h3>
              <ul className="space-y-4">
                {mainDishes.map((dish) => (
                  <li key={dish.key} className="flex items-center gap-3">
                    ...
                    <span className="font-sans text-champagne">
                      {t(`menu.${dish.key}`)}
                    </span>
                  </li>
                ))}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {activities.map((activity) => {
              ...
              return (
                <div
                  key={activity.key}
                  className="bg-card rounded-2xl p-6 text-center shadow-soft border border-burgundy/10 hover:shadow-elegant transition-all duration-300"
                >
