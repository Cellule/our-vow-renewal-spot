...
import { Sparkles, Palette, Phone } from "lucide-react";
        ...
        <div className="mb-16">
          ...
          <div className="bg-card rounded-2xl p-8 shadow-soft border border-burgundy/10 max-w-3xl mx-auto">
            <div className="text-center mb-6">
              <span className="inline-block bg-gradient-gold text-burgundy font-serif text-lg px-6 py-2 rounded-full">
                {t("event.dressCodeTheme")}
              </span>
            </div>
            <p className="font-sans text-foreground text-center leading-relaxed">
              {t("event.dressCodeDetails")}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-gradient-elegant rounded-2xl p-8 shadow-elegant max-w-3xl mx-auto">
            <div className="text-champagne">
              ...
              <p className="font-serif text-gold text-lg mb-4">
                {t("event.colorPaletteAvoid")}
              </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            {[
              ...
              <div key={gem.name} className="flex flex-col items-center">
                <div
                  className="w-12 h-12 rounded-full border-2 border-cream shadow-lg"
